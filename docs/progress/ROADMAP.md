...
Publication: 2026-09-06. Items retain their evidence date. An absent item is not considered closed; source-level claims require runtime proof for closure.
...
|---|---|---|
| A_RUNTIME_ENTRY_LINEAGE — A immutable entry/decision/position/event lineage | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| B_FEATURE_CONTRACT — B feature reduction and versioned parity contract | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| C_STATE_MODEL — C deterministic state model parity and drift | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| C_CROSS_COIN_EVENT_MODEL — C cross-coin event identity and best-one/two counterfactual | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| D_EXPERIMENT_REGISTRY — D durable experiment registry and lineage | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| D_NEGATIVE_MEMORY — D negative-memory repeat prevention | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| E_EXPERIMENT_FACTORY — E bounded automatic experiment factory | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| E_DECAY_FRESHNESS — E current decay and freshness windows | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| F_META_PORTFOLIO — F meta decision and portfolio selection | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| G_CHAMPION_CHALLENGER — G champion/challenger/shadow gating | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| G_POSITIVE_CANDIDATES — G v141/v143/v145/v149/v150 candidate terminal lifecycle | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| ML_AUTOPILOT_LOCAL_LOOP — Local ML autonomous memory-to-next-experiment loop | CURRENT_LOCAL_RUNTIME_PROVEN | 2026-09-06 |
...
| MYX_WATCH_TERMINAL_COVERAGE — MYX terminal coverage and breakeven semantics | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| ONDO_ADA_OPEN_CLOSED_LIFECYCLE — ONDO/ADA open-to-closed lifecycle truth | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| UNIFIED_MEMORY_WRITE — Unified learning-memory writes | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| UNIFIED_MEMORY_READ — Memory reads before ML/router selection | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| UNIFIED_MEMORY_PROVEN_EFFECT — Measured without/with-memory effect | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| MEMORY_MACHINE_READABLE — Versioned machine-readable knowledge | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| MEMORY_HUMAN_READABLE — Human-readable learning summaries | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| PORTABLE_KNOWLEDGE_EXPORT — Portable knowledge export and provenance | WAITING_PUBLIC_STATUS_EXPORT_PROOF | 2026-09-06 |
| CHAT8_LOCAL_TRACKER — Local same-ID 5m prediction tracker | CURRENT_LOCAL_RUNTIME_PROVEN | 2026-09-06 |
| CHAT8_SCHEDULED_MARKET_INTELLIGENCE — Scheduled material market-intelligence cycle | CURRENT_LOCAL_RUNTIME_PROVEN | 2026-09-06 |
| CODEX_RESEARCH_ONLY_BRANCH — Complete no-capital Codex prediction-to-memory branch | CURRENT_RESEARCH_PREDICTION_PROVEN | 2026-09-06 |
...
| WEBUI_LAYOUT_RESPONSIVE — WebUI responsive layout and no browser errors | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| WEBUI_USER_DATA_QUALITY — User-facing N/A/current/historical semantics | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| WEBUI_DECISIONS_PAGE — Current decisions page chronology | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| WEBUI_TRADE_TABLE — Complete trade table | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| WEBUI_TRADE_CHART — Trade chart entry/exit truth page | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| WEBUI_PERFORMANCE — Measured WebUI overview performance | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| CHAT1_ROLE — Chat1 ML/factory/memory role liveness | REPLACED_BY_LOCAL_SERVICE | 2026-09-06 |
| CHAT2_ROLE — Chat2 strategy/risk/challenger role liveness | REPLACED_BY_LOCAL_SERVICE | 2026-09-06 |
| CHAT3_ROLE — Chat3 forward/watch/outcome role liveness | REPLACED_BY_LOCAL_SERVICE | 2026-09-06 |
| CHAT4_ROLE — Chat4 independent non-duplicate QA | REPLACED_BY_LOCAL_SERVICE | 2026-09-06 |
| CHAT5_ROLE — Chat5 integrate/reconcile/failure-control role | REPLACED_BY_LOCAL_SERVICE | 2026-09-06 |
| CHAT6_ROLE — Chat6 runtime/storage/visible-terminal role | REPLACED_BY_LOCAL_SERVICE | 2026-09-06 |
| CHAT7_ROLE — Chat7 read-only completeness audit role | REPLACED_BY_LOCAL_SERVICE | 2026-09-06 |
| CHAT8_ROLE — Chat8 prospective intelligence role | REPLACED_BY_LOCAL_SERVICE | 2026-09-06 |
| EVENT_DRIVEN_ORCHESTRATION — Event-driven dispatch over scheduled message-bus use | REPLACED_BY_LOCAL_SERVICE | 2026-09-06 |
| SUPERVISOR_RETURN_CHAIN — Worker terminal to Chat5 return to next child | REPLACED_BY_LOCAL_SERVICE | 2026-09-06 |
| REQUIREMENT_TASK_MATERIALIZATION — OPEN/PARTIAL code-fixable has exactly one task | REPLACED_BY_LOCAL_SERVICE | 2026-09-06 |
| STATUS_EVENT_CONSUMPTION — Incremental status/event evidence consumption | REPLACED_BY_LOCAL_SERVICE | 2026-09-06 |
| TERMINAL_COVERAGE_DEDUPLICATION — Terminal evidence prevents duplicate work | REPLACED_BY_LOCAL_SERVICE | 2026-09-06 |
| NON_STARVATION_PARALLELISM — Independent owner work must not starve | REPLACED_BY_LOCAL_SERVICE | 2026-09-06 |
| AUTONOMOUS_CHAIN_ACCEPTANCE — Multiple-owner autonomous chain acceptance | REPLACED_BY_LOCAL_SERVICE | 2026-09-06 |
| LAUNCHER_CWD_INDEPENDENCE — Launcher CWD independence | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| USER_SESSION_TRANSPORT — Project outbox user-session bridge | REPLACED_BY_LOCAL_SERVICE | 2026-09-06 |
| RESERVED_CLAIM_STATE_MACHINE — Shared reservation claimability predicate | REPLACED_BY_LOCAL_SERVICE | 2026-09-06 |
| DEFENDER_SAFE_OPERATIONS — Defender-safe fail-closed operations | CURRENT_LOCAL_QA_PROVEN | 2026-09-06 |
| DB_SAFETY_CONCURRENCY — SQLite/WAL/atomic concurrency safety | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| DATA_QUALITY_CAUSAL_PATH — Prospective data causal-path quality | WAITING_CAUSAL_SOURCE_PROOF | 2026-09-06 |
...
| TRADE_OUTCOME_PIPELINE_LIVENESS — Timestamp-bound Paper/Watch/Forward candidate-to-outcome liveness truth | IMPLEMENTED_AWAITING_CURRENT_PROOF | 2026-09-06 |
| CODEX_IMMUTABLE_PORTFOLIO_DRIFT — Fail-closed immutable Codex shadow portfolio drift repair and bounded prediction backlog | CURRENT_PREDICTION_ONLY_AWAITING_DRIFT_PROOF | 2026-09-06 |
