...
|---|---|---|---|---|---|---|
| Canonical-history integrity | historical-record integrity | `2026-09-04T22:34:50Z` | No | `PASS` | `canonical_history_integrity.json` | observed artifact only |
| Paper-watch guard | paper/watch boundary guard | `2026-09-04T21:08:51Z` | No | `PASS` | `paper_watch_guard_last.json` | observed artifact only |
| Runtime context gate | required runtime-context completeness | `2026-09-04T21:08:51Z` | No | `FAIL_INCOMPLETE_V3_CONTEXT`; `7` cases | `runtime_entry_snapshot_coverage.json` | blocked; not independently rerun |
| Research autopilot | research eligibility boundary | `2026-09-04T22:43:04Z` | No | `QUICK`, activation `False`, eligible `1` | `research_autopilot_last.json` | observed artifact only |
