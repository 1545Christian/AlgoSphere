...
|---|---|---|---|---|---|---|
| Canonical-history integrity | historical-record integrity | `2026-09-05T22:38:18Z` | No | `PASS` | `canonical_history_integrity.json` | observed artifact only |
...
| Research autopilot | research eligibility boundary | `2026-09-05T22:39:55Z` | No | `QUICK`, activation `False`, eligible `43` | `research_autopilot_last.json` | observed artifact only |
