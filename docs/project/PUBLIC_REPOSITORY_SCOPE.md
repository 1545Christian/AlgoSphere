...
- proprietary strategy parameters and private execution configuration
- private deployment and infrastructure details
...
The purpose is to keep a public, reviewable record of what has actually been built, tested, rejected, improved and left unresolved.

That includes negative results.
