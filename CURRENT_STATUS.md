...
|---|---|---|---|---|
| Canonical-history integrity | `PASS` | `2026-09-03T00:56:40Z` | observed in current artifact | integrity gate reports its state |
| Paper-watch guard | `PASS` | `2026-09-02T22:40:13Z` | observed in current artifact | guard observation does not activate trading |
| Runtime context gate | `FAIL_INCOMPLETE_V3_CONTEXT` | `2026-09-02T22:40:13Z` | blocked | context is not treated as complete |
| Remaining runtime context cases | `7` | `2026-09-02T22:40:13Z` | blocked | highest-priority remediation remains open |
| Research profile | `QUICK` | `2026-09-03T00:58:42Z` | observed in current artifact | profile label only |
| Activation allowed | `False` | `2026-09-03T00:58:42Z` | observed in current artifact | activation is not permitted by the observed artifact |
| Eligible experiments | `0` | `2026-09-03T00:58:42Z` | observed in current artifact | no eligible experiment is reported |
...
- **observed in current artifact:** values in the table were read as scalars at `2026-09-03T00:59:11Z UTC / 2026-09-03 01:59 Westeuropäische Sommerzeit Atlantic/Canary`.
