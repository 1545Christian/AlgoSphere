...
|---|---|---|---|---|
| Canonical-history integrity | `PASS` | `2026-09-01T18:20:55Z` | observed in current artifact | integrity gate reports its state |
| Paper-watch guard | `PASS` | `2026-09-01T18:10:25Z` | observed in current artifact | guard observation does not activate trading |
| Runtime context gate | `FAIL_INCOMPLETE_V3_CONTEXT` | `2026-09-01T18:10:25Z` | blocked | context is not treated as complete |
| Remaining runtime context cases | `7` | `2026-09-01T18:10:25Z` | blocked | highest-priority remediation remains open |
| Research profile | `QUICK` | `2026-09-01T18:21:42Z` | observed in current artifact | profile label only |
| Activation allowed | `False` | `2026-09-01T18:21:42Z` | observed in current artifact | activation is not permitted by the observed artifact |
| Eligible experiments | `0` | `2026-09-01T18:21:42Z` | observed in current artifact | no eligible experiment is reported |
...
- **observed in current artifact:** values in the table were read as scalars at `2026-09-01T18:21:54Z UTC / 2026-09-01 19:21 Westeuropäische Sommerzeit Atlantic/Canary`.
