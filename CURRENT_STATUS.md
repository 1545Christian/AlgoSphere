...
| Research profile | `QUICK` | `2026-09-01T00:15:16Z` | observed in current artifact | profile label only |
| Activation allowed | `False` | `2026-09-01T00:15:16Z` | observed in current artifact | activation is not permitted by the observed artifact |
| Eligible experiments | `0` | `2026-09-01T00:15:16Z` | observed in current artifact | no eligible experiment is reported |
...
- **observed in current artifact:** values in the table were read as scalars at `2026-09-01T00:17:25Z UTC / 2026-09-01 01:17 Westeuropäische Sommerzeit Atlantic/Canary`.
