...
|---|---|---|---|---|
| Canonical-history integrity | `PASS` | `2026-09-01T18:05:40Z` | observed in current artifact | integrity gate reports its state |
...
| Research profile | `QUICK` | `2026-09-01T18:16:32Z` | observed in current artifact | profile label only |
| Activation allowed | `False` | `2026-09-01T18:16:32Z` | observed in current artifact | activation is not permitted by the observed artifact |
| Eligible experiments | `0` | `2026-09-01T18:16:32Z` | observed in current artifact | no eligible experiment is reported |
...
- **observed in current artifact:** values in the table were read as scalars at `2026-09-01T18:18:03Z UTC / 2026-09-01 19:18 Westeuropäische Sommerzeit Atlantic/Canary`.
