...
Exportintegrität: verifiziert. Siehe [Aktueller Status](../CURRENT_STATUS.md), [Testergebnisse](../TEST_RESULTS.md) und die verbindliche [Evidenzübersicht](../evidence/EVIDENCE_SUMMARY.md).
<!-- AUTO_VALUES_END -->
