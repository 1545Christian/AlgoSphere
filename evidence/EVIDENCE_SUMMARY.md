...
<!-- AUTO_VALUES_START -->
**Export integrity: verified.** Current sanitised register count: `1946`; published hashes: `1945`; `HASH_NOT_PUBLISHED` rows: `1`.
